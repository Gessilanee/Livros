...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { author: @livro.author, description: @livro.description, name: @livro.name } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { author: @livro.author, description: @livro.description, name: @livro.name } }
